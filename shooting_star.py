...
class Fighter(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.image.load('fighter.png') #이미지 가져오기
...
class Missile(pygame.sprite.Sprite):
    def __init__(self, xpos, ypos, speed):
        ...
        self.image = pygame.image.load('missile.png') #이미지 구현
        self.rect = self.image.get_rect()
        self.rect.x = xpos
        self.rect.y = ypos
        self.speed = speed
...
def game_loop():
    ...
    occur_prob = 40 # 확률적으로 얼만큼 나오게 할 것인가
    shot_count = 0 # 맞힌 개수
    ...
    while not done:
        ...
        draw_text('파괴한 개수: {}'.format(shot_count),default_font, screen, 100, 20, YELLOW)
        draw_text('놓친 개수: {}'.format(count_missed),default_font, screen, 400, 20, RED)
...
def game_menu():
    ...
    draw_text('SHOOTINGSTAR', font_70,screen, draw_x, draw_y, YELLOW)
